...
export const DonationsPageCardKnown = () => {
    ...
    <Card className={cx(styles.root, shadowStyles.root)}>
      ...
      <CardContent className={styles.content}>
        <TextInfoCardContent
          ...
          heading={'Every Donation Counts! Tell us your story!'}
          body={
            'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.'
          }
        />
        <Button color={'primary'} fullWidth className={styles.cta} href={'/donations/known'}>
          Donate Now! <ChevronRightRounded />
        </Button>
      </CardContent>
    </Card>
  );
...
export default DonationsPageCardKnown;